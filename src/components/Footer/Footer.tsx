    ...
    <footer>
      <div className='container py-[48px]'>
        <div className='grid grid-cols-5 gap-4'>
          ...
          <div className='col-span-1'>
            <h3 className='mb-2 text-[13px] font-semibold fill-text uppercase'>Thanh toán</h3>
            <ul className='flex flex-wrap'>
              <li className='mb-2 mr-2 shadow-[rgba(50,_50,_105,_0.25)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] p-1 rounded-sm'>
          ...
          <div className='col-span-1'>
            <h3 className='mb-2 text-[13px] font-semibold fill-text uppercase'>Theo dõi chúng tôi trên</h3>
            <ul>
              <li>
                <a
                  href='https://www.facebook.com/ShopeeVN'
                  target='_blank'
                  className='mb-1 text-[12px] font-light capitalize text-[#3f3f3f] hover:text-[#ee4d2d] flex items-center'
                  rel='noreferrer'
                >
              ...
              <li>
                <a
                  ...
                  rel='noreferrer'
                >
                  <i className='fa-brands fa-square-instagram text-[16px] mr-2'></i>
                  <span>Instagram</span>
                </a>
              </li>
              <li>
                <a
                  ...
                  rel='noreferrer'
                >
                  <i className='fa-brands fa-linkedin text-[16px] mr-2'></i>
                  <span>Linkedin</span>
                </a>
              </li>
            </ul>
            ...
            <div className='flex'>
              ...
              <div className='ml-3 flex flex-col justify-between'>
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='shadow-[rgba(50,_50,_105,_0.25)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] p-1 rounded-sm'
                >
                  <img
